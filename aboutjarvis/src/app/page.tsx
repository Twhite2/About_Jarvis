    ...
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <main className="main-content px-6 sm:px-12 md:px-20 py-20">
        ...
        <section id="projects" className="py-20 max-w-7xl mx-auto">
          ...
          {/* Project 4 - AI Voice Translation */}
          <ProjectCard
            number={4}
            title="AI-Powered Real-Time Voice Translation Platform"
            description="Designed and developed a real-time voice communication platform with AI-powered speech recognition, translation, and text-to-speech integration. The system enables seamless cross-language conversations using cloud APIs and a responsive Electron-based interface."
            projectLink="https://github.com/Twhite2"
            imageSrc="/images/Screenshot (270).png"
            deviceType="laptop"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="flex items-center justify-center relative">
              <div className="about-image-container">
                ...
                >
                  <Image
                    src="/images/WhatsApp Image 2026-03-22 at 12.00.36 PM.jpeg"
                    alt="Samuel Tuinperi"
                    fill
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              ...
              <div className="flex flex-col space-y-4">
                ...
                <a 
                  href="https://www.linkedin.com/in/emmanuel-frank-opigo-52788a230/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center text-lg hover:text-primary transition-colors"
                  onMouseEnter={() => setCursorVariant("text")}
